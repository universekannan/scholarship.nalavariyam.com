            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                 ...
                 @foreach($exams as $e)
                    <tr> 
                    <td>{{ $e->title }}</td>
                    <td>{{ date("d-M-Y",strtotime($e->from_date)) }}</td>
                    <td>{{ date("d-M-Y",strtotime($e->to_date)) }}</td>
                    <td>{{ $e->section_name }}</td>
                    <td>
             
          <a href="{{ url('/topper') }}/{{ $e->id }}" class="btn btn-danger btn-sm"><i class="fas fa-arrow-circle-right"></i> Toppers</a>
          <a href="{{ url('/distop') }}/{{ $e->id }}" class="btn btn-danger btn-sm"><i class="fas fa-arrow-circle-right"></i> District Toppers</a>
